...
export const useUpdateCourseAction = () => {
  ...
  const updateCourse = async (id, courseData) => {
    ...
    try {
      const data = await updateCourseMutation.mutateAsync({
        id,
        data: courseData,
      });
...
export const useAssignLecturersAction = () => {
  ...
  const assignLecturers = async (courseId, lecturers) => {
    console.log("[STORE] useAssignLecturersAction called", {
      courseId,
      lecturers,
    });
    setLoading(true);
    ...
    try {
      const data = await assignLecturersMutation.mutateAsync({
        id: courseId,
        lecturers,
      });
...
export const useRemoveLecturersAction = () => {
  ...
  const removeLecturers = async (courseId, lecturers) => {
    console.log("[STORE] useRemoveLecturersAction called", {
      courseId,
      lecturers,
    });
    setLoading(true);
    ...
    try {
      const data = await removeLecturersMutation.mutateAsync({
        id: courseId,
        lecturers,
      });
...
export const useUploadCourseMaterialAction = () => {
  ...
  const uploadMaterial = async ({ courseId, file, description, type }) => {
    console.log("[STORE] useUploadCourseMaterialAction called", {
      courseId,
      description,
      type,
    });
    ...
    try {
      ...
      const data = await uploadMaterialMutation.mutateAsync({
        courseId,
        file,
        description,
        type,
...
export const useDeleteCourseMaterialAction = () => {
  ...
  const deleteMaterial = async ({ courseId, materialId }) => {
    console.log("[STORE] useDeleteCourseMaterialAction called", {
      courseId,
      materialId,
    });
    showLoader();
    try {
      const data = await deleteMaterialMutation.mutateAsync({
        courseId,
        materialId,
      });
...
export const useAssignToCourseAction = () => {
  ...
  const assignToCourse = async (
    ...
    console.log("[STORE] useAssignToCourseAction called", {
      courseId,
      students,
      lecturers,
    });
    ...
    showLoader();
    try {
      const data = await assignToCourseMutation.mutateAsync({
        id: courseId,
        students,
        lecturers,
      });
...
export const useRemoveFromCourseAction = () => {
  ...
  const removeFromCourse = async (
    ...
    console.log("[STORE] useRemoveFromCourseAction called", {
      courseId,
      students,
      lecturers,
    });
    ...
    showLoader();
    try {
      const data = await removeFromCourseMutation.mutateAsync({
        id: courseId,
        students,
        lecturers,
      });
