...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-50 via-white to-orange-50 overflow-hidden">
      ...
      <div className="absolute top-40 left-20 w-72 h-72 bg-blue-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
      <div className="absolute -bottom-20 right-40 w-72 h-72 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>

      <div className="max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-28 relative">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-14 lg:gap-16 items-center">
          {/* Left Content */}
          <div className="text-center lg:text-left space-y-6 lg:space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-50 border border-orange-200 rounded-full text-orange-600 text-sm font-medium animate-fade-in">
              <GraduationCap className="w-4 h-4" />
              <span>#1 CBT PLATFORM FOR ACADEMIC EXCELLENCE</span>
            </div>

            {/* Main Heading (slightly reduced on very large screens for better fit) */}
            <h1 className="text-4xl sm:text-5xl lg:text-5xl font-bold text-gray-900 leading-tight animate-slide-up">
              Secure & Reliable.
              <br />
            ...
            {/* Description */}
            <p className="text-lg text-gray-600 leading-relaxed max-w-xl mx-auto lg:mx-0 animate-slide-up animation-delay-200">Experience seamless computer-based testing with UNIDEL's advanced platform. Schedule exams, take tests, and receive instant results—all in one secure environment.</p>

            {/* Features */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 text-sm text-gray-600 animate-slide-up animation-delay-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-slide-up animation-delay-400">
              <Link to="/portal-signin" className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gray-900 text-white font-semibold rounded-xl hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl hover:scale-105">
                Start Free Trial
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>

              <button onClick={() => setIsVideoPlaying(true)} className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-gray-900 font-semibold rounded-xl hover:bg-gray-50 transition-all shadow-md hover:shadow-lg border border-gray-200">
                <div className="flex items-center justify-center w-10 h-10 bg-orange-500 rounded-full group-hover:bg-orange-600 transition-colors">
            ...
            {/* Stats */}
            <div className="flex flex-wrap gap-8 justify-center lg:justify-start pt-4 animate-slide-up animation-delay-500">
              <div>
          ...
          <div className="relative animate-fade-in animation-delay-600 flex justify-center lg:justify-end">
            ...
            <div className="absolute -top-8 right-8 z-10 animate-float">
              <div className="w-28 h-28 bg-white rounded-full shadow-xl flex items-center justify-center border-4 border-orange-500">
                <div className="text-center">
                  <GraduationCap className="w-10 h-10 text-orange-600 mx-auto mb-1" />
                  <div className="text-xs font-semibold text-gray-900">Best CBT</div>
