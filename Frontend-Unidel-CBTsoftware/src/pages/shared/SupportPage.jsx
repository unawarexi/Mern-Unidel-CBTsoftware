    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        {isLoading ? (
          ...
          <div
            className={cn(
              "text-center p-12 rounded-xl border border-dashed",
              isDarkMode
                ? "bg-gray-900 border-gray-800"
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div
              className={cn(
                "rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200",
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className={cn(
                        "w-full p-2.5 rounded-lg border bg-transparent",
                        isDarkMode
