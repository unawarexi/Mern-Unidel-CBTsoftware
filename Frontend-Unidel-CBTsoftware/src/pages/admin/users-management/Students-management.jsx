...
const StudentsManagement = () => {
  ...
  const handleEdit = (student) => {
    ...
    reset({
      ...
      email: student.email || "",
      department:
        typeof student.department === "object" && student.department?._id
  ...
  const filteredStudents = (students || []).filter((student) => {
    ...
    const matchesLevel =
      filterLevel === "All" || student.level === Number(filterLevel);
    const matchesCourse =
      filterCourse === "All" ||
          ...
          <div className="flex flex-wrap gap-2 sm:gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 w-full sm:max-w-md order-3 sm:order-2">
              ...
              <input
                ...
                className={cn(
                  "w-full pl-8 sm:pl-10 pr-2 sm:pr-4 py-1.5 sm:py-2 text-xs sm:text-base border rounded-xl focus:outline-none focus:ring-2 transition-colors",
                  isDarkMode
                    ? "bg-slate-800 border-slate-700 text-white placeholder-slate-500 focus:ring-orange-500/50 focus:border-orange-500"
                    : "bg-white border-slate-300 text-slate-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500/20",
                )}
              />
            </div>
            ...
            <div className="flex gap-1.5 sm:gap-3 w-full sm:w-auto order-2 sm:order-3 overflow-x-auto pb-1 sm:pb-0">
              <select
                ...
                className={cn(
                  "px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-base border rounded-xl focus:outline-none focus:ring-2 min-w-[80px] sm:flex-1 sm:min-w-0",
                  isDarkMode
                    ? "bg-slate-800 border-slate-700 text-white focus:ring-orange-500/50"
                    : "bg-white border-slate-300 text-slate-900 focus:ring-orange-500/20",
                )}
              >
              ...
              <select
                ...
                className={cn(
                  "px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-base border rounded-xl min-w-[70px] sm:flex-1 sm:min-w-0",
                  isDarkMode
              ...
              <select
                ...
                className={cn(
                  "px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-base border rounded-xl min-w-[100px] sm:flex-1 sm:min-w-0",
                  isDarkMode
                    ? "bg-slate-800 border-slate-700 text-white"
                    : "bg-white border-slate-300 text-slate-900",
                )}
                  ...
                  {filteredStudents.map((student, index) => {
                    ...
                    return (
                      ...
                      >
                        <td
                          className={cn(
                            "px-2 sm:px-6 py-2 sm:py-4 font-medium text-[10px] sm:text-base",
                            isDarkMode ? "text-white" : "text-slate-900",
                          )}
                        >
                          ...
                          <div
                            className={cn(
                              "sm:hidden text-[9px] mt-0.5 truncate max-w-[100px]",
                        ...
                        <td
                          className={cn(
                            "px-2 sm:px-6 py-2 sm:py-4 text-[10px] sm:text-base",
                            isDarkMode ? "text-slate-400" : "text-slate-600",
                          )}
                        >
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      disabled
                      className={cn(
                        "w-full px-4 py-2 border rounded-lg cursor-not-allowed",
                        isDarkMode
