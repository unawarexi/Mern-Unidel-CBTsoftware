  ...
  useEffect(() => {
    if (department) {
      setFormData({
        ...
        levels: Array.isArray(department.levels)
          ? department.levels.map((l) => l.level).join(", ")
          : "",
      });
    }
  }, [department]);
  ...
  return (
    <div className="min-h-screen bg-white p-6 flex items-center justify-center">
      <motion.div
        ...
        className="bg-white rounded-xl p-8 w-full max-w-lg border border-slate-200 shadow-xl"
      >
