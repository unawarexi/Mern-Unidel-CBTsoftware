...
const AdminDashboard = () => {
  ...
  const totalSubmissions =
    dashboardStats?.overview?.submissions?.totalSubmissions || 0;
  const passedSubmissions =
    dashboardStats?.overview?.submissions?.passedSubmissions || 0;
  const failedSubmissions = totalSubmissions - passedSubmissions;
  const passRate = parseFloat(
    dashboardStats?.overview?.submissions?.passRate || 0,
  );
  const failRate =
    totalSubmissions > 0
      ? ((failedSubmissions / totalSubmissions) * 100).toFixed(2)
      : 0;
  ...
  const performanceMetrics = [
    ...
    },
    {
      ...
      value:
        totalExams > 0
          ? `${((completedExams / totalExams) * 100).toFixed(1)}%`
          : "0%",
    ...
    },
    {
      ...
      textColor:
        systemAnalytics?.systemErrors > 10 ? "text-red-600" : "text-gray-600",
    },
  ];
  ...
  const userDistribution = [
    ...
    {
      name: "Admins",
      value: dashboardStats?.overview?.users?.totalAdmins || 5,
      color: "#f97316",
    },
  ];
  ...
  const departmentData = (
    dashboardStats?.distribution?.studentsByDepartment ||
  ...
  const highRiskDepartments =
    dashboardStats?.security?.highRisk?.departments || [];
      ...
      <div className="max-w-[1600px] mx-auto">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <select
                ...
                className={cn(
                  "px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-base rounded-xl border focus:outline-none focus:ring-2 focus:ring-orange-500",
                  isDarkMode
              ...
              <button
                ...
                disabled={refreshing}
                className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-base bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:bg-gray-400"
              >
                <RefreshCw
          ...
          {statsLoading || studentsLoading || lecturersLoading || coursesLoading
            ? Array(4)
                ...
                .map((_, idx) => (
                  <div
                    key={idx}
                    className={cn(
                      "rounded-xl p-3 sm:p-5 border shadow-sm",
                      isDarkMode
            ...
            : quickStats.map((stat, idx) => (
                <motion.div
                  ...
                  onClick={() =>
                    stat.link && (window.location.href = stat.link)
                  }
                >
                  ...
                  <div className={cn("text-xs mt-0.5 sm:mt-1", stat.textColor)}>
                    {stat.change}
                  </div>
                </motion.div>
              ))}
          ...
          {statsLoading
            ? Array(4)
                ...
                .map((_, idx) => (
                  <div
                    key={idx}
                    className={cn(
                      "rounded-xl p-3 sm:p-4 border shadow-sm",
                      isDarkMode
                        ? "bg-slate-900 border-slate-800"
                        : "bg-white border-gray-100",
                    )}
            ...
            : performanceMetrics.map((metric, idx) => (
                <motion.div
                  ...
                  className={cn(
                    "rounded-xl p-3 sm:p-4 shadow-sm border",
                    isDarkMode
                      ? "bg-slate-900 border-slate-800"
                      : "bg-white border-gray-100",
                  )}
                  ...
                  <div className="flex items-center justify-between mb-1 sm:mb-2">
                    <div
                      className={cn(
                        ...
                        isDarkMode ? "bg-slate-800" : metric.lightBg,
                        metric.textColor,
                      )}
                    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 sm:gap-4 mb-2 sm:mb-4">
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            className={cn(
              "lg:col-span-6 rounded-xl p-3 sm:p-5 shadow-sm border",
              isDarkMode
                ? "bg-slate-900 border-slate-800"
                : "bg-white border-gray-100",
            )}
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            className={cn(
              "lg:col-span-3 rounded-xl p-3 sm:p-5 shadow-sm border",
              isDarkMode
                ? "bg-slate-900 border-slate-800"
                : "bg-white border-gray-100",
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 sm:gap-4 mb-2 sm:mb-4">
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="lg:col-span-6 grid grid-cols-2 gap-2 sm:gap-4"
          >
            {/* Exam Status */}
            <div
              className={cn(
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-4 mb-2 sm:mb-4">
          ...
          >
            <div className="flex items-center justify-between mb-2 sm:mb-4">
              ...
              <button className="text-xs sm:text-sm text-blue-600 font-medium hover:text-blue-700 flex items-center gap-1 transition-colors">
                View All
            ...
            <div className="space-y-3">
              {pendingTasks.map((task, idx) => (
                <div
                  ...
                  onClick={() =>
                    task.link && (window.location.href = task.link)
                  }
                >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs sm:text-base text-white text-opacity-90">
                  Monitor exam integrity violations across the system
                </p>
              </div>
                      ...
                      <div className="text-right">
                        ...
                        {student.autoSubmits > 0 && (
                          <div className="text-xs text-orange-600">
                            {student.autoSubmits} auto-submits
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    {violationsByType.slice(0, 4).map((type, idx) => (
                      <div
                        key={idx}
                        className={cn(
                          "flex items-center justify-between py-1 border-b last:border-0",
                  ...
                  <div className="space-y-2">
                    {highRiskDepartments.slice(0, 3).map((dept, idx) => (
                      ...
                      >
                        ...
                        >
                          {dept.violationCount} violations
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-3 sm:p-6 shadow-lg"
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
            <button
              onClick={() => (window.location.href = "/admin/users/students")}
            ...
            <button
              onClick={() =>
                (window.location.href = "/admin/question-bank/approvals")
              }
              className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white p-4 rounded-lg transition-all flex flex-col items-center gap-2"
            >
