        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="relative w-full max-w-xs">
              ...
              <input
                ...
                className={cn(
                  ...
                  isDarkMode
                    ? "bg-slate-800/50 border-slate-700 text-white placeholder-slate-500 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500"
                    : "bg-gray-50 border-gray-300 text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent",
                )}
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-end space-x-1.5 sm:space-x-3 flex-1">
            ...
            <div className="relative ml-1 sm:ml-2">
              ...
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center overflow-hidden shadow-lg">
