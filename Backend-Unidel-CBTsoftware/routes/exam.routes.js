...
router.put(
  "/question-bank/:id/questions/:questionId",
  protect,
  authorize("lecturer"),
  updateQuestionInBank,
);
...
router.get(
  "/question-bank/pending/approvals",
  protect,
...
router.post(
  "/exams/from-question-bank",
  protect,
  authorize("lecturer"),
  createExamFromQuestionBank,
);

// Get all exams for lecturer (and admin for dashboard)
router.get(
  "/exams",
  protect,
  authorize("lecturer", "admin", "superadmin"),
  getLecturerExams,
);
...
router.get(
  "/exams/:id",
  protect,
  authorize("lecturer", "student", "admin"),
  getExamById,
);
