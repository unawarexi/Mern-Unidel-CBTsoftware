...
const DEFAULT_BRANDING = {
  INSTITUTION_NAME: "University of Delta",
  TAGLINE: "Computer Based Test Platform",
  LOGO_URL:
    "https://res.cloudinary.com/dkt3rfpgz/image/upload/v1767626977/unidel2_hrn11f.png",
...
export const generatePDFFromTemplate = async (options) => {
  ...
  const referenceId = `UNIDEL-${Date.now().toString(36).toUpperCase()}`;
